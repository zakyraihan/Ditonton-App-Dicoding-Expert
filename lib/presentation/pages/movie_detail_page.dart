...
class DetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<MovieDetailBloc, MovieDetailState>(
      listenWhen: (previous, current) => previous.watchlistMessage != current.watchlistMessage && current.watchlistMessage != '',
                              ...
                              FilledButton(
                                onPressed: () async {
                                  if (!isAddedWatchlist) {
                                    ...
                                    context.read<MovieDetailBloc>().add(OnRemoveFromWatchlist(movie));
                                  }
                                },
                                child: Row(
                              ...
                              Row(
                                children: [
                                  RatingBarIndicator(
                                    ...
                                    itemCount: 5,
                                    itemBuilder: (context, index) => const Icon(Icons.star, color: kMikadoYellow),
                                    itemSize: 24,
                                  ),
